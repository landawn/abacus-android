...
public abstract class ObserverX<T> extends com.landawn.abacus.util.Observer<T> implements Immutable {
     ...
     * @param <O>
     */
    protected static abstract class UIObserverBase<T, O extends UIObserverBase<T, O>> extends ObserverX<T> implements Disposable {
        ...
        @Deprecated
        @Override
        public ObserverX<T> distinctBy(final Function<? super T, ?> keyMapper) {
            throw new UnsupportedOperationException();
        }
        ...
        @Deprecated
        @Override
        public <U> ObserverX<U> map(final Function<? super T, U> map) {
            throw new UnsupportedOperationException();
        }
        ...
        @Deprecated
        @Override
        public <U> ObserverX<U> flatMap(final Function<? super T, Collection<U>> map) {
            throw new UnsupportedOperationException();
        }
        ...
        @Deprecated
        @Override
        public ObserverX<List<T>> buffer(final long timespan, final TimeUnit unit) {
            throw new UnsupportedOperationException();
        }
        ...
        @Deprecated
        @Override
        public ObserverX<List<T>> buffer(final long timespan, final TimeUnit unit, final int count) {
            throw new UnsupportedOperationException();
        }
        ...
        @Deprecated
        @Override
        public ObserverX<List<T>> buffer(final long timespan, final long timeskip, final TimeUnit unit) {
            throw new UnsupportedOperationException();
        }
        ...
        @Deprecated
        @Override
        public ObserverX<List<T>> buffer(final long timespan, final long timeskip, final TimeUnit unit, final int count) {
            throw new UnsupportedOperationException();
        }
